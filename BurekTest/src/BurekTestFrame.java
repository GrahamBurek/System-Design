...
public class BurekTestFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BurekTestFrame frame = new BurekTestFrame();
	 ...
	 * Create the frame.
	 */
	public BurekTestFrame() {
		jbInit();
	}
	private void jbInit() {
		setTitle("Burek First Day Example");
		...
		lblHello.setBounds(116, 47, 81, 14);
		...
		btnChange.setBounds(335, 227, 89, 23);
